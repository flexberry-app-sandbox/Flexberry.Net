...
namespace IIS.Net
{
    ...
    public class Рекомендац : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Net.ПричинУвольн fПричинУвольн;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Net.ПричинУвольн.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ПричинУвольн"})]
        public virtual IIS.Net.ПричинУвольн ПричинУвольн
        {
            get
            {
                ...
                IIS.Net.ПричинУвольн result = this.fПричинУвольн;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РекомендацE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РекомендацE", typeof(IIS.Net.Рекомендац));
                }
            }
        }
    }
    ...
    public class DetailArrayOfРекомендац : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Net.DetailArrayOfРекомендац members)

        // *** End programmer edit section *** (IIS.Net.DetailArrayOfРекомендац members)
        ...
        /// </summary>
        public DetailArrayOfРекомендац(IIS.Net.ПричинУвольн fПричинУвольн) : 
                base(typeof(Рекомендац), ((ICSSoft.STORMNET.DataObject)(fПричинУвольн)))
        {
        }
        
        public IIS.Net.Рекомендац this[int index]
        {
            get
            {
                return ((IIS.Net.Рекомендац)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Net.Рекомендац dataobject)
        {
